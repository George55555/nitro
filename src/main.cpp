...
unsigned int nStakeMinAge = 5 * nOneHour; // as zero time weight
unsigned int nStakeMaxAge = 2600 * 24 * nOneHour; // no upper limit
...
const string strMessageMagic = "NitroCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("NitroCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NitroCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // NitroCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NitroCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "nitro genesis";
        CTransaction txNew;
        txNew.nTime = 1494266826;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1494266826;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 103371; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb0, 0xf1, 0xea, 0xe5 };
