...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XTR");
    case mBTC: return QString("mXTR");
    case uBTC: return QString::fromUtf8("μXTR");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("NitroCoins"));
    case mBTC: return QString(QObject::tr("Milli-NitroCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-NitroCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
