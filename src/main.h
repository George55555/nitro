...
static const uint256 hashGenesisBlock("0x0000b9d67136f5f381dc931ef19fdd25639d841512dd46736c8cae0cceba2bfe");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((10 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at NitroCoin block #0
        ...
        // Before NitroCoin block #0 - get from pregenerated table
